...
private object BinaryClassificationICPMetrics extends Logging {
  def allSignificances(
    mondrianPvAndLabels: Seq[(Array[Double], Double)]) = {
...
class BinaryClassificationICPMetrics private (
  val mondrianPvAndLabels: Seq[(Array[Double], Double)],
  private val sigLowerBound: Double,
  private val sigUpperBound: Double,
  private val sigs: Seq[Double]) extends Serializable {

  def this(mondrianPvAndLabels: Array[(Array[Double], Double)]) = {
  ...
  def this(
    mondrianPvAndLabels: Array[(Array[Double], Double)],
